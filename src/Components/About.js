...
const About = () => (
  <Route path="/about" render={() => (
    <div className="about-container">
      ...
      <p>To showcase my work I built my first website <a href="www.christophercarrphotography.co.uk">christophercarrphotography.co.uk</a> It was challenging but I enjoyed the process, and seeing the finished product gave me huge sense of achievement.</p>
